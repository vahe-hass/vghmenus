                ...
                <div class="col-sm-4">
                    <div class="dashboard-box margin-top-0">
                      ...
                      <div class="content with-padding">
                        Get in touch with us by filling out the contact form or by using the contact information provided. We would be happy to answer any questions or concerns you may have.
                      </div>
                    </div>
