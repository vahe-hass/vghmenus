                                        ...
                                        <div class="panel panel-default quickad-main">
                                            <div class="panel-body">
                                                <h4 class="quickad-block-head">
                                                    <span class="quickad-category-title">Allergies</span>
                                                ...
                                                <form method="post" id="new-blog-cat-form" style="display: none">
                                                    <div class="form-group quickad-margin-bottom-md">
                                                        <div class="form-field form-required">
                                                            <label for="new-allergy-title">Title</label>
                                                ...
                                                <div class="quickad-margin-top-xlg" id="ab-services-list">
                                                    <div class="panel-group ui-sortable" id="services_list" role="tablist" aria-multiselectable="true">
                                                        <?php
                                                        $rows = ORM::for_table($config['db']['pre'].'allergies')
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <form method="post" id="<?php echo $row['id']; ?>">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6 col-sm-12">
                                                                                    <div class="form-group">
                                                                                        <label for="image_<?php echo $row['id']; ?>">Image Url</label>
                                                                                        <input name="image" value="<?php echo $row['image']; ?>" id="image_<?php echo $row['id']; ?>" class="form-control" type="url">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6 col-sm-12">
                                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="panel-footer">
                                                                                <button type="button" class="btn btn-lg btn-success ladda-button ajax-type-edit" data-style="zoom-in" data-spinner-size="40" onclick="editAllergies(<?php echo $row['id']; ?>);">
...
<script>
    function editAllergies(id){
        $('.ajax-type-edit').addClass('bookme-progress').prop('disabled',true);
        var data = $('#'+id).serialize();
        $.post(ajaxurl+'?action=editAllergies&'+data, function (response) {
            if (response != 0) {
...
<script src="js/custom-manage/allergies.js"></script>
